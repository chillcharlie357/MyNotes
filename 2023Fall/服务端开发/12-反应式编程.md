...
- Subscriber：数据订阅者
- Processor：处理器
	- 既是发布者又是订阅者，把订阅到的数据做一些处理，然后发布给别人
- Subscription：协调的媒介
	- Publisher通过Subscription向Subsriber发送消息
	- Subscriber通过Subscription向Publisher索取消息
...
[reactor3 flux的map与flatMap的区别 - code-craft - SegmentFault 思否](https://segmentfault.com/a/1190000013229461)
