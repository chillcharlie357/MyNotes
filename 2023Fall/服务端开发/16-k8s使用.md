...
### 3.1.2. 如何将pod或service的端口快速映射到本机端口（调试用）
...
## 3.4. 命令行快捷创建deployment、service、ingress
...
- 自动：kubectl autoscale deployment spittr--min=10 --max=15 --cpu-percent=80
