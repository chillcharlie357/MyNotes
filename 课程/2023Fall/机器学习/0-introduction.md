...
- 生成式模型
	...
	- 即学习xy的联合概率分布，$p(x,y)=p(x|y)p(y)$
	- 用先验概率和条件算后验
	- 例：朴素贝叶斯、隐马尔科夫就是生成式模型，先学习特点，再进行比较
...
$P(A|B)$为已知B发生后，A的条件概率，成为A的后验概率  
$P(A)$是A的先验概率，不考虑任何B的因素

![image.png](https://chillcharlie-img.oss-cn-hangzhou.aliyuncs.com/image%2F2024%2F01%2F02%2F22-24-32-d0942d4ad66eeede6b7a14998b109e16-20240102222431-b8255f.png)
